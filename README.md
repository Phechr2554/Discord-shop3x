...
- คัดลอกโปรเจกต์ไปไว้ที่ `~/xbot`
- สร้าง virtual environment
- ให้กรอกค่า `.env` ทีละช่อง
- สร้าง systemd service
- ติดตั้งคำสั่ง `menubot` ให้เรียกได้จากทุกโฟลเดอร์
...
หลังติดตั้งบน VPS แล้ว พิมพ์ `menubot` ได้จากทุกที่ รวมถึงหน้า `~` ไม่ต้องอยู่ในโฟลเดอร์โปรเจกต์ก็ใช้งานได้

เมนูมีดังนี้:
1. ถอนการติดตั้ง — ยืนยัน 3 รอบก่อนดำเนินการ
2. ดูสถานะการทำงาน
3. รีสตาร์ทระบบ — ข้อมูลในฐานข้อมูลไม่หาย
4. ล้างข้อมูลทั้งหมดในฐานข้อมูล — ยืนยัน 3 รอบก่อนดำเนินการ
5. อัปเดตสคริประบบ
