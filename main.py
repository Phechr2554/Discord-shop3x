...
@bot.command(name="deletecredits")
@bot.command(name="Deletecredits")
...
@bot.command(name="settingsmycredit")
@bot.command(name="Settingsmycredit")
...
@bot.command(name="freeclientresettime")
@bot.command(name="freeclientResettime")
...
@bot.command(name="purchaseinformation")
@bot.command(name="Purchaseinformation")
...
@bot.command(name="showpurchaselist")
@bot.command(name="Showpurchaselist")
